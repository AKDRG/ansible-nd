...
class BaseVrfStrategy(ABC):
    """
    Abstract base for VRF endpoint and workflow strategies.
    ...
    Concrete strategies are selected at runtime by VrfFabricResolver
    ...
    def config_model_cls(self) -> type:
        ...
        - Standalone / child → VrfConfigModel
        - Parent (MSD / MFD) → VrfParentConfigModel
        """
    ...
    def configure_endpoint(self, ep) -> None:
        """
        Hook called by NDVrfOrchestrator._make_endpoint after fabric_name is set.
