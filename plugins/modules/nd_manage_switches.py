...
__author__ = "Akshayant Chengam Saravanan"

DOCUMENTATION = """
---
module: nd_manage_switches
short_description: Manage switches in Cisco Nexus Dashboard Fabric Controller (NDFC).
version_added: "1.0.0"
author: Akshayant Chengam Saravanan (@achengam)
description:
...
from ansible_collections.cisco.nd.plugins.module_utils.nd_switch_resources_v2 import NDSwitchResourceModule
...
def main():
    ...
    try:
        log_config = Log()
        log_config.config = "/Users/achengam/Documents/Ansible_Dev/ND/ansible_collections/cisco/nd/ansible_cisco_log_r.json"
        log_config.commit()
